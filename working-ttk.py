...
def popup_client():
    ...
    # comobox.bind('<<ComboboxSelected>>', combobox_selected)
...
class MyApp(ttk.Frame):
    def __init__(self, master):
        ...
        self.label = ttk.Label(self, text="Welcome the Image/Video Sender, Receiver and viewer", font = ("Lato", 24))
        ...
        self.label_frame2 = ttk.Labelframe(self, text = "View Files", bootstyle = "white")
        self.label_frame2.pack(padx=5, pady=5, fill=ttk.BOTH, expand=True)
        self.button = ttk.Button(self.label_frame2, text="view files", command=self.file_exp, style = 'my.TButton')
        self.button.pack(padx= 5, pady= 5)
        ...
        self.label_frame4 = ttk.Labelframe(self, text = "Create Your Stage Name", bootstyle = "white")
        self.label_frame4.pack(padx=5, pady=5, fill=ttk.BOTH, expand=True)
        self.button = ttk.Button(self.label_frame4, text="Set Client Name", command=self.on_click, style = "my.TButton")
        self.button.pack(padx= 5, pady= 5)
